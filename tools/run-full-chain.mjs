...
function callSidecar(args, stdinObj) {
  for (let n = 0; ; n++) {
    ...
    if (!/529|overloaded|temporarily|wait longer|timeout|SIGKILL|usage limit|ECONNRESET|ECONNREFUSED|Unable to connect|socket hang up|Connection closed/i.test(err)) {
