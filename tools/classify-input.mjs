...
// skeleton 슬롯: workflow-doc(spec 필드)이면 문서 전체, 레거시 skeleton 이면 {program}(exec-stage 가 판별).
const embed = skeleton.spec === "workflow-doc@0.0.1" ? skeleton : { program: skeleton.program };
process.stdout.write(
  JSON.stringify({ skeleton: embed, stage: "classify", args: { directive, ledger, chunkRef: "chunk" } }),
);
